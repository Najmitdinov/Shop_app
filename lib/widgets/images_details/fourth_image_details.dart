...
class FourthImageDetails extends StatefulWidget {
  Product product;
  final Function() saveForm;
  FourthImageDetails(this.product, this.saveForm, {super.key});

  @override
  State<FourthImageDetails> createState() => _ImageDetailsState();
}

class _ImageDetailsState extends State<FourthImageDetails> {
  @override
