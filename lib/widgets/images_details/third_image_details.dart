...
class ThirdImageDetails extends StatefulWidget {
  Product product;
  final Function() saveForm;
  ThirdImageDetails(this.product, this.saveForm, {super.key});

  @override
  State<ThirdImageDetails> createState() => _ImageDetailsState();
}

class _ImageDetailsState extends State<ThirdImageDetails> {
  @override
